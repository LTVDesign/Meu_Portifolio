  ...
  const formacoes: FormacaoData[] = [
    {
      ...
      logo: facul,
      period: '2023 - 2025',
      description: 'Formação superior com carga horária total de 2100h, focada no ciclo completo de desenvolvimento de software, análise de requisitos e gestão de projetos. Concluído em 13/12/2025.',
      link: '#',
      disciplinas: [
        '2023/2: Engenharia de Software (Nota: 87)',
        '2023/2: Linguagem de Programação (Nota: 10.00)',
        '2023/2: Lógica e Matemática Computacional (Nota: 10.00)',
        '2023/2: Algoritmos e Programação Estruturada (Nota: 10.00)',
        '2023/2: Análise e Modelagem de Sistemas (Nota: 10.00)',
        '2024/1: Análise Orientada a Objetos (Nota: 99)',
        '2024/1: Linguagem Orientada a Objetos (Nota: 10.00)',
        '2024/1: Modelagem de Dados (Nota: 10.00)',
        '2024/1: Projeto de Extensão I - ADS (Nota: 10.00)',
        '2024/1: Qualidade e Automação de Testes (Nota: 88)',
        '2024/2: Sistemas Operacionais (Nota: 10.00)',
        '2024/2: Computação em Nuvem (Nota: 8.00)',
        '2024/2: Governança de Tecnologia (Nota: 10.00)',
        '2024/2: Green It (Nota: 10.00)',
        '2024/2: Programação e Desenvolvimento de Banco de Dados (Nota: 10.00)',
        '2025/1: Programação Web (Nota: 10.00)',
        '2025/1: Desenvolvimento em Javascript (Nota: 99)',
        '2025/1: Desenvolvimento Mobile (Nota: 10.00)',
        '2025/1: Desenvolvimento Responsivo (Nota: 81)',
        '2025/1: Frameworks para Desenvolvimento de Software (Nota: 98)',
        '2025/1: Projeto de Extensão II - ADS (Nota: 10.00)',
        '2025/1: Sistemas Distribuídos (Nota: 10.00)',
        '2025/2: Arquitetura e Organização de Computadores (Nota: 10.00)',
        '2025/2: Projeto de Software (Nota: 10.00)',
        '2025/2: Redes de Computadores (Nota: 10.00)',
        '2025/2: Segurança e Auditoria de Sistemas (Nota: 10.00)',
        '2025/2: Sociedade Brasileira e Cidadania (Nota: 10.00)',
        '2025/2: Interface e Usabilidade (Nota: 10.00)'
      ]
    },
    {
      id: '2',
