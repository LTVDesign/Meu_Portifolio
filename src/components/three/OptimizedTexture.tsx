...
interface OptimizedTextureProps {
    urls: string | string[];
    type?: 'albedo' | 'normal' | 'roughness' | 'metalness' | 'emissive' | 'ao' | 'height' | 'specular' | 'opacity' | 'displacement' | 'roughness-metalness' | 'noise';
    anisotropy?: number;
...
const OptimizedTexture = ({
    ...
    }, [textures, type, anisotropy, isLowPerformance, wrapS, wrapT, repeat, flipY, premultiplyAlpha]);
