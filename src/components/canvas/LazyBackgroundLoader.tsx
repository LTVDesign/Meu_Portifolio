 ...
 */
export function LazyBackgroundLoader({ backgroundType, fallback = null, ...props }: LazyBackgroundLoaderProps) {
    const [shouldLoad, setShouldLoad] = useState(false);
    const [BackgroundComponent, setBackgroundComponent] = useState<ComponentType<any> | null>(null);
