      ...
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12 lg:px-16 py-4 flex items-center justify-between ml-20 md:ml-36">
        ...
        <div className="hidden sm:flex items-center gap-2 ml-auto">
          ...
          <m.button
            ...
            whileTap={{ scale: 0.95 }}
            className={`group relative px-2 py-1.5 text-xs font-black uppercase tracking-wider rounded-lg transition-all overflow-hidden ${i18n.language === 'pt'
          ...
          >
            ...
            <div
              className="absolute inset-0 opacity-60 bg-cover bg-center rounded-lg group-hover:opacity-80 transition-opacity"
              style={{
          ...
          <m.button
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
            className={`group relative px-2 py-1.5 text-xs font-black uppercase tracking-wider rounded-lg transition-all overflow-hidden ${i18n.language === 'en'
