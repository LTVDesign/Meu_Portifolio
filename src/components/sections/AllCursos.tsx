                    ...
                    {sortedCursos.map((curso) => (
                        ...
                        >
                            <div className="flex-1">
                                <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-[var(--cyber-cyan)] transition-colors">
                                    {curso.title}
                                </h3>
                                <p className="text-[var(--cyber-purple)] font-bold uppercase tracking-widest mb-2">{curso.platform}</p>
                                <p className="mt-4 text-[var(--text-secondary)] flex-1 leading-relaxed">
                                    {curso.description}
                                </p>
                                <div className="mt-6 flex items-center gap-4 text-xs text-white/50 font-mono">
