      ...
      <div className="space-y-16">
        {Object.entries(technologiesByCategory).map(([category, techs]) => (
          <div key={category}>
            ...
            >
              <p className="text-[var(--cyber-purple)] uppercase tracking-widest text-sm font-bold opacity-60">{category}</p>
              <h3 className="section-title mt-2 drop-shadow-[0_0_15px_rgba(145,94,255,0.4)]">{techs.length} Tecnologias</h3>
            </motion.div>
