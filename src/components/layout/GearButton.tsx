          ...
          <div className='relative group/gear'>
            ...
            <div className='absolute inset-0 flex items-center justify-center'>
              <m.div
                ...
                style={{
                  background:
                    'conic-gradient(from 0deg, #915EFF, #00D4FF, #FF6B9D, #00FF88, #915EFF)',
                  filter: 'blur(25px)',
                  opacity: 0.6,
                }}
                animate={{ rotate: 360 }}
              ...
              <m.div
                ...
                style={{
                  background:
                    'conic-gradient(from 180deg, #00D4FF, #915EFF, #FF6B9D, #00FF88, #00D4FF)',
                  filter: 'blur(20px)',
                  opacity: 0.5,
                }}
                animate={{ rotate: -360 }}
              ...
              <m.div
                ...
                style={{
                  background:
                    'conic-gradient(from 90deg, #FF6B9D, #00D4FF, #915EFF, #00FF88, #FF6B9D)',
                  filter: 'blur(15px)',
                  opacity: 0.4,
                }}
                animate={{ rotate: 360 }}
            ...
            >
              ...
              >
                ...
                <m.svg
                  ...
                  style={{
                    filter:
                      'drop-shadow(0 0 10px rgba(145,94,255,0.9)) drop-shadow(0 0 20px rgba(0,212,255,0.7)) drop-shadow(0 0 30px rgba(255,107,157,0.5))',
                  }}
                >
                  <defs>
