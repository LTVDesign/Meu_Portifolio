...
const ParticulateEditor: React.FC<ParticulateEditorProps> = ({
  config,
  updateConfig,
}) => (
        ...
        <div className='space-y-3'>
          <div className='block'>
            ...
            <select
              ...
              onChange={(e) =>
                updateConfig({ particulatePalette: e.target.value as string })
              }
            ...
            <div className='grid grid-cols-2 gap-x-3 gap-y-2 pt-1'>
              {([1, 2, 3, 4, 5, 6] as const).map((i) => (
                <ColorControl
                  ...
                  onChange={(v) =>
                    updateConfig({ [`particulateColor${i}`]: v as string })
                  }
                />
              ))}
            </div>
